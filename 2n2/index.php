...
style="wigth: 100px;
			 ...
			 <div id="main">
			   <div id="news">
				 ...
				 <!--Статья-->
				 <div class="article">
				    <img src="img/venator/1.jpg" alt="test" title="Test">
					<span> Звёздный разрушитель типа «Венатор» </span>
					</div>
					
					<div class="article">
					<img src="img/4.jpg" alt="test" title="Test">
					<span> Звёздный суперразрушитель типа «Палач» </span>
					</div>
					
					<div class="article">
					<img src="img/2.jpg" alt="test" title="Test">
					<span> Звёздный разрушитель типа «Имперский» </span>
					</div>
					
					<div class="article">
					<img src="img/1.jpg" alt="test" title="Test">
					<span> Дредноут типа «Затмение» </span>
					</div>
